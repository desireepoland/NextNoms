      ...
      if (status === google.maps.places.PlacesServiceStatus.OK) {
        ...
        $("#"+placeId).on('click', function(){
          ...
          if(!$("#"+placeId).find('.expander-trigger').hasClass('expander-hidden')){
            ...
            infowindow.setContent('<div><strong>' + place.name + '</strong><br>' +
            place.formatted_address + '<br><a href="https://www.google.com/maps/dir/Current+Location/'+place.geometry.location.lat().toString()+','+ place.geometry.location.lng().toString() + '">Get Directions</a></div>');
